...
function Product({countItems, setCountItems, setAddToCart}: Props) {
    ...
    return (
        <>
            <div className="row align-items-start m-0 pt-0 pt-md-4 px-0 px-md-5">
                <div className="col-12 col-md-5 p-0 p-md-auto">
                    <div className='d-flex align-items-center'>
                        <button className="d-block d-md-none btn-modal-prev rounded-circle position-absolute" onClick={() => setActivePhoto(prev => prev === 0 ? 3 : prev - 1)}><img src="images/icon-previous.svg"></img></button>
                        <img src={`images/image-product-${activePhoto + 1}.jpg`} className='img-fluid img-product' alt={`image-product-${activePhoto + 1}`} onClick={() => {setIsModalShowed(true); setActiveModalPhoto(activePhoto)}}></img>
                        <button className="d-block d-md-none btn-modal-next rounded-circle position-absolute" onClick={() => setActivePhoto(prev => prev === 3 ? 0 : prev + 1)}><img src="images/icon-next.svg"></img></button>
                    </div>

                    <div className='d-none d-md-flex align-items-center justify-content-between mt-4 border-none'>
                ...
                <div className="div-product-data col-12 col-md-7 d-flex flex-column align-items-start my-auto px-5 px-md-auto py-4 py-md-auto">
                    ...
                    <p className='pt-2 pt-md-3'>These low-profile sneakers are your perfect casual wear companion. Featuring a 
                    durable rubber outer sole, they’ll withstand everything the weather can offer.</p>

                    <div className='d-flex d-md-block justify-content-between align-items-center mb-2 mb-md-0 w-100'>
                        <div className='d-flex gap-2 align-items-center mb-0 mb-md-2'>
                            <p className='text-black fw-bold fs-4 m-0'>$125.00</p>
                            <p className='bg-black text-white fw-bold rounded-3 py-0 px-2 m-0'>50%</p>
                        </div>
                        <p className='text-decoration-line-through fw-bold mb-0 mb-md-4'>$250.00</p>
                    </div>

                    <div className='div-buy-info d-block d-md-flex gap-3'>
                        <div className='d-flex align-items-center gap-auto justify-content-between gap-md-3 rounded-3' style={{backgroundColor: "#f7f8fd"}}>
                        ...
                        <button className='btn-add-to-cart mt-3 mt-md-0' onClick={() => {countItems !== 0 ? setAddToCart(true) : setAddToCart(false)}}>
